...
*Branch: `claude/pm-assistant` | Last updated: 2026-06-26 | v3.4*
...
| **Designer** | **#281** | /admin/documents/:id DETAIL full revamp — inverted IA, self-party-gated, rights surface (QC doc-detail report + PM adversarial verify 2026-06-26) | **Pre-pilot, gates FE** |
