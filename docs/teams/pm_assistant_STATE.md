...
| **ALL** | **#300** ✅ EPIC | **Document Detail Screen EPIC** — gom #281/#282/#284/#297 + §13 clause-edit re-read addendum. DEC-048 RATIFIED (Kevin 2026-06-26). Phasing 0a (pre-pilot: P1–P5 + G1/G2 fix + backfill + clause edit + re-read-after-P1) → 0b (join tables + conjunction + diff UX) → T1/T2 AI. Each team = own PR per lane (DEC-047). | **Pre-pilot core 🔴** |
